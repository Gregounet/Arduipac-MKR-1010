...
arduipac: arduipac.o arduipac_vmachine.o arduipac_8048.o arduipac_8245.o arduipac_bios_rom.o arduipac_cset.o arduipac_input.o mnemonics.o
	$(CC) $(LFLAGS) arduipac.o arduipac_vmachine.o arduipac_8048.o arduipac_8245.o arduipac_bios_rom.o arduipac_cset.o arduipac_input.o mnemonics.o -o arduipac

clean:
	rm -f arduipac.o arduipac_8048.o arduipac_8245.o arduipac_bios_rom.o arduipac_cset.o arduipac_input.o mnemonics.o
...
arduipac_8245.o: arduipac_8245.c arduipac_8245.h arduipac_8048.h arduipac_vmachine.h arduipac_cset.h
